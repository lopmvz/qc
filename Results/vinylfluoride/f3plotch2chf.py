...
data1 = np.genfromtxt('CH2CHF_F_ee_Pbs.lor')
x1 = data1[:,0] 
y1 = (data1[:,1])
data1 = np.genfromtxt('CH2CHF_F_ee_Pbs.txt')
stcksx1 = data1[:,0] 
stcksy1 = (data1[:,1])

data2 = np.genfromtxt('CH2CHF_F_ee_Dbs.lor')
x2 = data2[:,0] 
y2 = (data2[:,1])
data2 = np.genfromtxt('CH2CHF_F_ee_Dbs.txt')
stcksx2 = data2[:,0]
stcksy2 = (data2[:,1])

data3 = np.genfromtxt('CH2CHF_F_ee_PRbs.lor')
x3 = data3[:,0] 
y3 = (data3[:,1])
data3 = np.genfromtxt('CH2CHF_F_ee_PRbs.txt')
stcksx3 = data3[:,0]
stcksy3 = (data3[:,1])

data4 = np.genfromtxt('CH2CHF_F_ee_DRbs.lor')
x4 = data4[:,0] 
y4 = (data4[:,1])
data4 = np.genfromtxt('CH2CHF_F_ee_DRbs.txt')
stcksx4 = data4[:,0]
stcksy4 = (data4[:,1])

#Experiment
data5 = np.genfromtxt('CH2CHF_F.csv')
x5 = data5[:,0] 
y5 = (data5[:,1])
...
ax3.plot(x5new, y5new/30, 'black', label='Experiment' , linewidth=2 )
