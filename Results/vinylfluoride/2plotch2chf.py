...
ax2.plot(x4+x2shift, y4, 'firebrick', label='CVS-EOM-EE ( %.2f eV)' %x2shift, linewidth=2)#, linestyle='--')
#ax2.plot([ip1+x1shift,ip1+x1shift],[0,yip],'crimson',linewidth=1.0, dashes=[5, 2])
ax2.plot([ip2+x2shift,ip2+x2shift],[0,yip],'firebrick',linewidth=1.0, dashes=[5, 2])
#ax2.plot([ip3+x1shift,ip3+x1shift],[0,yip],'crimson',linewidth=1.0, dashes=[5, 2])
ax2.plot([ip4+x2shift,ip4+x2shift],[0,yip],'firebrick',linewidth=1.0, dashes=[5, 2])
...
n=len(stcksx4)
for i in range(n):
    ax2.plot([stcksx4[i]+x2shift,stcksx4[i]+x2shift],[0,stcksy4[i]*0.5],'firebrick',linewidth=1.0)
